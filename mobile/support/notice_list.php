                ...
                <div class="board-list">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="title"><a href="#"><span class="label label-on">채용중</span>친환경건축자재(HB) 일반 성적서</a></td>
                                <td>관리자</td>
                                <td>06-03-15</td>
                            </tr>
                            <tr>
                                <td class="title"><a href="#"><span class="label label-off">마감</span>친환경건축자재(HB) 일반 성적서</a></td>
                                <td>관리자</td>
                                <td>06-03-15</td>
                            </tr>
                        </tbody>
